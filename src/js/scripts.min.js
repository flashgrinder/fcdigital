...
document.addEventListener('DOMContentLoaded', function () {
  var loaderScreen = document.querySelector('.js-loader-screen');
  var jsLinksTrs = document.querySelectorAll('.js-transition-link, .wysiwyg a');
  var jsLinksPage = Array.prototype.slice.call(jsLinksTrs); // loaderScreen.classList.add('is-open');
  ...
  function eventLink(e) {
    ...
    if (target.hasAttribute('href') && !target.getAttribute('target')) {
      e.preventDefault(); // loaderScreen.classList.add('is-active');
  ...
  jsLinksPage.forEach(function (element) {
    element.addEventListener('click', eventLink, true);
  });
});

},{"gsap":1}],5:[function(require,module,exports){
"use strict";

var _transitionPage = _interopRequireDefault(require("../libs/modules/transition-page.js"));
...
},{"../libs/modules/Marquee3k.js":2,"../libs/modules/burger-menu.js":3,"../libs/modules/transition-page.js":4}]},{},[5]);
